...
export const metadata: Metadata = {
  ...
  description:
    "Compare ReservKit with FareHarbor when evaluating direct booking software for rentals, tours, payments, waivers, and operator workflows.",
  keywords: ["FareHarbor alternative", "FareHarbor competitor", "FareHarbor replacement"],
...
const comparison = [
  ...
  {
    feature: "Payments",
    competitor: "Verify payout and processor terms during evaluation",
    reservkit: "Stripe Connect with operator-owned Stripe accounts",
  },
  {
    feature: "Waivers",
    competitor: "Confirm included features and add-ons for your account",
    reservkit: "Digital waiver workflows built into operator setup",
  },
  {
    feature: "Migration",
...
const faqSchema = {
  ...
  mainEntity: [
    {
      "@type": "Question",
      name: "Is ReservKit a FareHarbor replacement?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "ReservKit can be evaluated as a FareHarbor alternative for operators who want direct booking, Stripe payments, waivers, and a simpler operational workflow. Operators should verify current FareHarbor terms before comparing costs.",
      },
    },
    {
      "@type": "Question",
      name: "Can I migrate from FareHarbor to ReservKit?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "ReservKit includes Migration Center V1 for structured import workflows. Migration fit depends on the data available from the current booking system.",
      },
    },
  ],
};
          ...
          <div className="mx-auto max-w-4xl text-center">
            ...
            <div className="mt-8">
              <TrackedLink
                ...
                properties={{ location: "fareharbor_hero" }}
          ...
          <div className="mx-auto max-w-4xl">
            ...
            <div className="overflow-hidden rounded-2xl border border-[var(--color-border)]">
              <div className="grid grid-cols-3 bg-navy text-sm font-semibold text-white">
                ...
                <div className="border-l border-white/10 px-4 py-3">FareHarbor</div>
        ...
        <section className="bg-[var(--color-surface)] px-6 py-16">
          <div className="mx-auto max-w-4xl">
            <h2 className="mb-6 text-2xl font-bold text-navy">
              When ReservKit is worth evaluating
            </h2>
            <div className="space-y-4 text-slate-700">
              <p>
                ReservKit is strongest when the main need is a direct booking link, clear checkout,
                digital waiver evidence, staff visibility, and straightforward operator-owned
                payment setup.
              </p>
              <p>
                Operators who depend heavily on external marketplace distribution should compare
                that requirement carefully before moving any production workflow.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-navy px-6 py-16">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <TrackedLink
              href={BETA_URL}
              event="beta_access_cta_clicked"
              properties={{ location: "fareharbor_footer" }}
